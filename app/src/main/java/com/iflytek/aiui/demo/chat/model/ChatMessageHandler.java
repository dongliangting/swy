...
import com.iflytek.aiui.demo.chat.handler.player.DefaultHandler;
...
import com.iflytek.aiui.demo.chat.handler.player.JokeHandler;
...
import com.iflytek.aiui.demo.chat.handler.player.MusicHandler;
import com.iflytek.aiui.demo.chat.handler.player.RadioDisposer;
import com.iflytek.aiui.demo.chat.handler.player.StoryHandler;
...
//            }
            if (mHandler != null) {
                ...
                boolean justResumeTTS = !mSemanticResult.service.startsWith("fake.") && TextUtils.equals(answer.getTTSContent(), mSemanticResult.answer);
