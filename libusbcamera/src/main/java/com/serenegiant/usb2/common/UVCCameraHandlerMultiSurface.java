...
package com.serenegiant.usb2.common;
...
public class UVCCameraHandlerMultiSurface extends AbstractUVCCameraHandler {
	...
	public static final UVCCameraHandlerMultiSurface createHandler(
		...
		return createHandler(parent, cameraView, 1, width, height, com.serenegiant.usb2.UVCCamera.FRAME_FORMAT_MJPEG, com.serenegiant.usb2.UVCCamera.DEFAULT_BANDWIDTH);
	}
	...
	public static final UVCCameraHandlerMultiSurface createHandler(
		...
		return createHandler(parent, cameraView, 1, width, height, com.serenegiant.usb2.UVCCamera.FRAME_FORMAT_MJPEG, bandwidthFactor);
	}
	...
	public static final UVCCameraHandlerMultiSurface createHandler(
		...
		return createHandler(parent, cameraView, encoderType, width, height, com.serenegiant.usb2.UVCCamera.FRAME_FORMAT_MJPEG, com.serenegiant.usb2.UVCCamera.DEFAULT_BANDWIDTH);
	}
	...
	public static final UVCCameraHandlerMultiSurface createHandler(
		...
		return createHandler(parent, cameraView, encoderType, width, height, format, com.serenegiant.usb2.UVCCamera.DEFAULT_BANDWIDTH);
	}
