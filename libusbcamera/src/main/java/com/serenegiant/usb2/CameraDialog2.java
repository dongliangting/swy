...
public class CameraDialog2 extends DialogFragment {
	private static final String TAG = CameraDialog2.class.getSimpleName();
	 ...
	 * @return
	 */
	public static CameraDialog2 showDialog(final Activity parent/* add parameters here if you need */) {
		CameraDialog2 dialog = newInstance(/* add parameters here if you need */);
		try {
	...
	public static CameraDialog2 newInstance(/* add parameters here if you need */) {
		final CameraDialog2 dialog = new CameraDialog2();
	...
	public CameraDialog2(/* no arguments */) {
