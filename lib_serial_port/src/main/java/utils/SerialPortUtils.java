...
//    private String path = "/dev/ttyACM0";
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        if(sendSuccessListener != null){
                            sendSuccessListener.onSendSuccess("串口数据发送成功=" + data_ );
                        }
                    }
                });
            }
    ...
    public OnSendSuccessListener sendSuccessListener = null;
    public static interface OnSendSuccessListener {
        public void onSendSuccess(String value);
    }
    public void setOnSendSuccessListener(OnSendSuccessListener dataReceiveListener) {
        sendSuccessListener = dataReceiveListener;
    }
